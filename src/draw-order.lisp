...
(u:fn-> register-draw-order (context trait) null)
(defun register-draw-order (context render-trait)
  (declare (optimize speed))
...
(u:fn-> resort-draw-order (context game-object) null)
(defun resort-draw-order (context game-object)
  (declare (optimize speed))
  (u:when-let* ((manager (context-draw-order context))
