...
;; (defun contact-exit (system collider1 collider2)
;;   (declare (optimize speed))
;;   (let ((contacts (contacts system)))
...
;; (defun remove-contacts (system collider)
;;   (let ((contacts (collision-system-contacts system)))
