...
(defun volume-contact-enter (volume1 volume2)
  ...
  (flet ((%enter (volume1 volume2)
    ...
    (setf (u:href (collision-volume-contacts volume1) volume2) volume2
          (u:href (collision-volume-contacts volume2) volume1) volume1)
...
(u:fn-> volume-contact-p (collision-volume collision-volume) (or collision-volume null))
(declaim (inline volume-contact-p))
(defun volume-contact-p (volume1 volume2)
  (declare (optimize speed))
  (u:href (collision-volume-contacts volume1) volume2))
...
(defun compute-volume-contact (volume1 volume2)
  ...
  (let* ((collided-p (collide-p volume1 volume2))
         (contact-p (volume-contact-p volume1 volume2)))
    (cond
