...
(u:fn-> handle-events (man::manager win::window) null)
...
(u:fn-> on-button-enter (man::manager &rest t) boolean)
...
(u:fn-> on-button-enabled (man::manager &rest t) boolean)
...
(u:fn-> on-button-exit (man::manager &rest t) boolean)
