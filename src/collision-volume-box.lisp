...
(defun make-box-box-translation (box1 box2)
  ...
  (let* ((axes (collision-volume-box-axes box1))
         ...
         (translation (v3:- (collision-volume-box-world-center box2)
                            (collision-volume-box-world-center box1))))
...
(defun update-collision-volume-box (box collider)
  ...
  (let* ((owner (trait-owner collider))
         ...
         (world-center (v3:lerp! (collision-volume-box-world-center box) min max 0.5))
    ...
    (v3:with-components ((h (collision-volume-box-half-extents box)))
      (setf (collision-volume-box-world-center box) world-center
